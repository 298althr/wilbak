...
with open('c:/Users/saviour/Documents/Wilbak/Orthom8pro/Results/BUSINESS_CONTEXT_UPDATED_1.csv', 'r') as f:
    reader = csv.reader(f)
    for row in reader:
        if len(row) < 3 or not row[0]: continue
        biz, param, val = row[0], row[1], row[2]
...
<div id="app">
  ...
  <main class="layout-container">
    <section class="hero-section anim-slide-up">
      ...
      <h1 class="hero-heading" style="color:var(--tx-main);">
        Business <em>Context</em> <br><strong>Parameters.</strong>
      </h1>
      <p class="body-text" style="max-width:640px; margin: 1.5rem auto 0;">
      ...
      <template x-if="selectedBiz">
        <div>
          <div class="modal-header">
            ...
            <h2 class="section-heading" style="font-size: 2.5rem; margin-bottom: 0.5rem;" x-text="selectedBiz.replace(/_/g, ' ')"></h2>
            <div>
            ...
            <div class="detail-grid">
              ...
              <div>
                ...
                <div class="detail-group">
                  ...
                  <div class="detail-value mono text-green-400" x-text="businesses[selectedBiz].Net_Capital_After_Year1_Cost.value"></div>
...
html_content = html_content.replace('<<JSON_DATA>>', json.dumps(businesses, indent=2))

os.makedirs('c:/Users/saviour/Documents/Wilbak/Orthom8pro/business-context', exist_ok=True)
with open('c:/Users/saviour/Documents/Wilbak/Orthom8pro/business-context/index.html', 'w') as f:
