...
<div id="mobile-drawer" role="dialog" aria-modal="true" aria-label="Navigation menu">
  ...
  <div class="drawer-footer">
    <a href="/audit/" class="btn-primary" style="justify-content:center; width:100%;">AUDIT ACCESS</a>
...
<header id="site-header">
  ...
  <div class="header-controls">
    ...
    <a href="/audit/" class="btn-primary">AUDIT ACCESS</a>
  </div>
  ...
  <div class="footer-grid">
    ...
    <div>
      ...
      <ul class="footer-links">
        ...
        <li><a href="/audit/">Institutional Access</a></li>
      </ul>
    </div>
  </div>
